...
import net.csjava.logistics.common.utils.IdCardUtils;
...
import net.csjava.logistics.enums.MemberIdCardVerifyStatus;
import net.csjava.logistics.enums.OrderStatus;
import net.csjava.logistics.enums.OrderType;
import net.csjava.logistics.enums.pickuptask.PickupDispatchTaskSignStatus;
...
import net.csjava.logistics.enums.transportorder.TransportOrderSchedulingStatus;
import net.csjava.logistics.enums.transportorder.TransportOrderStatus;
import net.csjava.logistics.feign.*;
import net.csjava.logistics.feign.common.GoodsTypeFeign;
import net.csjava.logistics.feign.courier.AppCourierFeign;
